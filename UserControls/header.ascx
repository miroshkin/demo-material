...
<script type="text/javascript">
    ...
    function SearchProduct(productName, productDrawing) {
        ...
        $('<div title="Поиск изделия" id="SearchResultsWindow"/>').appendTo('body').load("/Pages/SearchResults.aspx?productName=" + productName + "&productDrawing=" + productDrawing
...
<div>
    ...
    <div id="search" style="right: 160px;">
        <input type="button" value="Поиск изделия" id="SearchButton" onclick="$('#searchForTheFirstTime').val('true');SearchProduct('','');"
            class="search_button" />
    </div>
