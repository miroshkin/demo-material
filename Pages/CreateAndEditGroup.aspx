...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function EditGroup(ID, groupName, prefix) {
            ...
            $('tr[onclick^="EditGroup"]').css('font-weight', 'normal');
            $('tr[onclick^="EditGroup(\'' + ID + '\'"]').css('font-weight', 'bolder');
        ...
        $(function () {
            $(".resizable1").resizable(
            {
                ...
                resize: function (e, ui) {
                    ...
                    //Настраиваем отображение правой таблицы списка групп
                    SetRightTableParameters();
        ...
        //Настраиваем параметры элементов страницы
        function SetElementsSizes() {
            ...
            document.getElementById('dropdown').style.width = dropdown_width + "px";
            document.getElementById('tree_container').style.width = left_side_width + "px";
            //Настраиваем отображение правой таблицы 
            SetRightTableParameters();
            //Задаем максимальную ширину левой части
            SetMaxLeftSideWidth();
        }
        ...
        //Устанавливает максимальную ширину левой части страницы
        function SetMaxLeftSideWidth() {
            $('#left_side').css('max-width', window.innerWidth - 871);
        }

        //Настраивает отображение правой таблицы списка групп
        function SetRightTableParameters() {
            ...
            if (product_info_width > 845) {
                ...
                document.getElementById('group_name_header').style.width = "781px";
                //Устанавливаем ширину описания групп
                document.getElementById('productInfo').style.width = "845px";
            }
        }
                    ...
                    <div id="productInfo" class="productDescription">
                        <div>
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div id ="grid_view_wrapper" style="font-size: 12px; font-weight: normal; border: solid 1px grey; overflow-y: scroll; 
                                    overflow-x: hidden; top: 65px; position: absolute; border-top: none; width: 100%; bottom: -35px;"
