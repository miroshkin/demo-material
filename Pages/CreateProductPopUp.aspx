            ...
            <table style="font-family: Verdana; font-size: 13px; text-align: left; top: 50px;">
                ...
                <tr>
                   <td class="tableFieldName">
                    ...
                    <td style="font-size: 12px;">
                        <asp:TextBox ID="kod_skmtr" runat="server" CssClass="CreateProductTextBox" style="width:273px;" MaxLength="15"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                   <td class="tableFieldName">
                    ...
                    <td style="font-size: 12px;">
                        <asp:TextBox ID="kod_okpd" runat="server" CssClass="CreateProductTextBox" style="width:273px;" MaxLength="15"></asp:TextBox>
                    </td>
                </tr>
            </table>
