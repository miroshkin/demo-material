...
public partial class Pages_EditProductPopup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Код СКМТР
        string kod_skmtrParameter = Server.UrlDecode(Request.QueryString["kod_skmtr"]);

        //Код ОКПО
        string kod_okpdParameter = Server.UrlDecode(Request.QueryString["kod_okpd"]);
        ...
        switch (action) 
        {
            ...
            case "SaveChanges":
                ...
                SaveChanges(IDparameter, productNameParameter, drawingParameter, groupIDParameter, priceParameter, typeIDParameter, kod_okpdParameter, kod_skmtrParameter);
                LoadProductionInfoPartly(productNameParameter, drawingParameter, priceParameter, kod_okpdParameter, kod_skmtrParameter);
    ...
    private void LoadProductionInfoPartly(string productNameParameter, string drawingParameter, string priceParameter, string kod_okpdParameter,string kod_skmtrParameter)
    {
        ...
        //Код СКМТР
        kod_skmtr.Text = kod_skmtrParameter;
        //Код ОКПО
        kod_okpd.Text = kod_okpdParameter;
