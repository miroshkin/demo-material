...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //Пользователь авторизован только для редактирования кодов СКМТР и ОКПД
        ...
        function EditProduct(ID) {
            ...
            $('<div title="Редактирование изделия" id="EditProductPopUp2"/>').appendTo('body').load("/Pages/EditProductPopUp2.aspx?ID=" + ID + "&action=LoadProductionInfo").dialog({
                beforeClose: function (event, ui) {
                    fade_out();
                },
                show: { effect: 'fade', duration: 300 },
...
<body class="body" onload="showPageLoadingGif();document.getElementById('tree_container').scrollTop = document.getElementById('treeview_vertical_scroll').value;
    ...
    <form id="form1" runat="server">
                    ...
                    <div id="description" style="font-size: 13px; font-weight: normal;">
                        ...
                        <div id="button_block">
                            <div id="Div1" style="float: left;">
                                <div id="button_panel" class="button_panel">
                                    <input type="button" class="button" value="Нормы расхода материалов"
                                        style="top: 42px; margin-left: 37px; width: 235px; background-image: url(../Icons/scroll.png); background-position: 205px; background-repeat: no-repeat; float: left;"
                                    ...
                                    <asp:Button ID="CutButton" runat="server" CssClass="button cut_button" ToolTip="Вырезать изделие" OnClick="CutButton_Click" />
                                    <asp:Button ID="CopyButton" runat="server" CssClass="button copy_button" ToolTip="Копировать изделие" OnClick="CopyButton_Click" />
                                    <asp:Button ID="PasteButton" runat="server" CssClass="button paste_button" ToolTip="Вставить изделие" OnClick="PasteButton_Click" />
                                    <asp:Button ID="EditButton" runat="server" CssClass="button editor_button" ToolTip="Редактировать изделие" OnClientClick="EditProduct(document.getElementById('SelectedNodeID').value);return false;" />
                                </div>
                            </div>
                        ...
                        <asp:PlaceHolder ID="QuantityBlock" runat="server">
                            ...
                            <div id="amount" class="amount">
                                <asp:Label ID="QuantityLabel" runat="server" Text="Количество:">
                                </asp:Label>
        ...
        <asp:HiddenField ID="SelectedNodeValuePath" runat="server" />
