...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function EditProduct(ID) {
            ...
            $('td[onclick^="EditProduct"]').css('font-weight', 'normal');
            $('td[onclick^="EditProduct(\'' + ID + '\')"]').css('font-weight', 'bolder');

            
            if (ID != null) {
                document.getElementById('last_edited_element').value = ID;
            }
        ...
        function HighlightLastEditedElement() {

            var ID = document.getElementById('last_edited_element').value;
            if (ID != '') {
                $('td[onclick^="EditProduct(\'' + ID + '\')"]').css('font-weight', 'bolder');
            }
...
<body onload="showPageLoadingGif();document.getElementById('tree_container').scrollTop = document.getElementById('treeview_vertical_scroll').value;
    document.getElementById('grid_view_wrapper').scrollTop = document.getElementById('right_panel_vertical_scroll').value; 
    HighlightLastEditedElement();DisableMenuItem(); OnEnterPress();SetElementsSizes();AddLoadingGif();">
    ...
    <div id="loading" style="position: absolute; width: 100%; height: 100%; left: 50%; top: 50%;">
        <img src="../Icons/ajax-loader.gif" alt="Loading..." />
    </div>
    <script type="text/javascript">
        var ld = (document.all);
    ...
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="last_edited_element" runat="server" />
        ...
        <div class="wrap">
            ...
            <input type="hidden" id="right_panel_vertical_scroll" runat="server" />
                    ...
                    <div>
                        <asp:Panel ID="Panel1" runat="server">
                            <div style="top: 40px; position: absolute; width: 100%;">
                                ...
                                <div id="product_skmtr_header" style="width: 137px; position: absolute; top: 1px; left: 324px; font-size: 12px; background-color: #507CD1; color: White; text-align: center; height: 20px; padding-top: 4px; z-index: 90;">
                                    Код СКМТР
                                </div>

                                <div id="product_name_header" style="margin-top: 1px; margin-left: 462px; margin-right: -2px; font-size: 12px; background-color: #507CD1; color: White; text-align: center; height: 20px; padding-top: 4px; z-index: 90;">
                                    Наименование
                                </div>

                            </div>
                            <div id="grid_view_wrapper" style="font-size: 12px; font-weight: normal; border: solid 1px grey;
                                 overflow-y: scroll; overflow-x: hidden; 
                                 top: 65px; position: absolute; border-top: none; width: 100%; bottom: -35px;"
                                onscroll="document.getElementById('right_panel_vertical_scroll').value = this.scrollTop;">
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Код СКМТР" HeaderText="Код СКМТР" ConvertEmptyStringToNull="False" ShowHeader="False" />
