...
<body>
    <form id="form1" runat="server">
        <div class="specification_header">
            <div class="specification_header_kod_skmtr">
                Код СКМТР
            </div>
            <div class="specification_header_product_group">
                Группа
            </div>
            <div class="specification_header_product_name">
                Наименование
            </div>
            <div class="specification_header_drawing">
                ГОСТ
            </div>
            <div class="specification_header_unit_name">
                Ед.изм
            </div>
            <div class="specification_header_quantity">
                Норма
            </div>
        </div>
        ...
        <div class="specification_gridview">
            <asp:GridView ID="SpecificationView" runat="server" AutoGenerateColumns="False" ShowHeader="False" OnRowDataBound="SpecificationView_RowDataBound" GridLines="None">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="KOD_SKMTR">
                        
                        <ItemTemplate>
                            <div style="padding-left: 5px;width: 115px; overflow: hidden; white-space: normal;">
                                <%# Eval("KOD_SKMTR") %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ARTICLE_GROUP_NAME">
                        <ItemTemplate>
                            <div style="padding-left: 5px;width: 140px; overflow: hidden; white-space: normal;">
                    ...
                    <asp:TemplateField HeaderText="DRAWING">
                        ...
                        <ItemTemplate>
                            <div style="width: 265px;overflow: hidden; white-space: nowrap; ">
                                <%# Eval("DRAWING") %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="UNIT_NAME">
                        <ItemTemplate>
                            <div style="width: 60px; overflow: hidden; white-space: nowrap;text-align:center;">
                                <%# Eval("UNIT_NAME") %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="QUANTITY" >
                        <ItemTemplate>
                            <div style="width:  110px;overflow: hidden; white-space: nowrap;text-align:left; ">
                                <%# Eval("QUANTITY","{0:G9}") %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
