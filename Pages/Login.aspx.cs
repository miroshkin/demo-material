...
public partial class Account_Login : System.Web.UI.Page
{
    ...
    {
        LogIn.Attributes.Add("onclick", "RegisterUser();return false;");
    ...
    /// Первое приближение - true, если разрешено редактирование кодов СКМТР и ОКПД, false - если разрешено всё
    /// </summary>
    /// <param name="name"></param>
    /// <param name="password"></param>
    /// <returns></returns>
    [WebMethod]
    public static bool AuthorizateUser(string name)
    {
        string con = ConfigurationManager.ConnectionStrings["MEZ_ProductionConnectionString"].ConnectionString;

        using (SqlConnection sqlCon = new SqlConnection(con))
        {
            SqlCommand cmd = new SqlCommand("ogk_AuthorizateUser", sqlCon);
            cmd.CommandType = CommandType.StoredProcedure;
